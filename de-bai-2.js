// Bộ câu hỏi 2 (Độ khó: Dễ - Trung bình) - Tác giả: KARL MARX
const QUIZ_QUESTIONS = [
    ...
    },
    {
        ...
        correct: "B",
        explain: "Chủ nghĩa duy vật lịch sử là phương pháp luận khoa học do Marx sáng lập, áp dụng quan điểm duy vật biện chứng vào việc nghiên cứu lịch sử và đời sống xã hội."
    },
    {
    ...
    {
        question: "Phương thức sản xuất là sự thống nhất biện chứng giữa hai yếu tố nào?",
    ...
    },
    {
        ...
        answers: { A: "Sở thích cá nhân và lối sống hàng ngày", B: "Địa vị sở hữu đối với tư liệu sản xuất chủ yếu của xã hội", C: "Trình độ học vấn và bằng cấp chuyên môn", D: "Nguồn gốc xuất thân từ các vùng miền địa lý" },
        correct: "B",
    ...
    {
        question: "Luận điểm nổi tiếng mở đầu chương I của tác phẩm \"Tuyên ngôn của Đảng Cộng sản\" (1848)?",
    ...
    },
    {
        ...
        answers: { A: "Phân công lao động xã hội", B: "Tha hóa lao động (Alienation of labor)", C: "Đòn kết xã hội", D: "Tích lũy tư bản" },
        correct: "B",
    ...
    {
        question: "Theo Karl Marx, hình thức phân công lao động nào trong lịch sử dẫn đến sự hình thành ranh giới rõ rệt giữa lao động trí óc và lao động chân tay, củng cố thêm sự phân hóa giai cấp?",
        answers: { A: "Phân công lao động theo giới tính trong gia đình", B: "Phân công lao động tự nhiên giữa người già và trẻ nhỏ", C: "Phân công lao động xã hội lớn (tách biệt giữa công nghiệp và nông nghiệp, thành thị và nông thôn)", D: "Phân công lao động trong các tổ chức tôn giáo cổ đại" },
        correct: "C",
        explain: "Sự tách rời giữa thành thị và nông thôn, giữa công nghiệp và nông nghiệp gắn liền với sự phân chia xã hội thành những nhóm người chuyên làm quản lý, nghiên cứu (trí óc) và những nhóm người chuyên lao động trực tiếp (chân tay)."
    },
    {
        question: "Học thuyết nào của Karl Marx chỉ ra rằng các hệ tư tưởng thống trị trong bất kỳ thời đại nào cũng là hệ tư tưởng của giai cấp thống trị về mặt kinh tế?",
        answers: { A: "Thuyết duy vật lịch sử về ý thức xã hội (Kiến trúc thượng tầng)", B: "Thuyết tha hóa lao động", C: "Thuyết chức năng cấu trúc", D: "Thuyết tương tác biểu trưng" },
        correct: "A",
        explain: "Giai cấp nào chi phối những tư liệu sản xuất vật chất thì đồng thời cũng chi phối những tư liệu sản xuất tinh thần, do đó tư tưởng của những người không có tư liệu sản xuất tinh thần nói chung bị phụ thuộc vào giai cấp thống trị."
    },
    {
        question: "Karl Marx đánh giá vai trò của \"Tôn giáo\" trong xã hội có giai cấp như thế nào thông qua câu nói nổi tiếng \"Tôn giáo là thuốc phiện của nhân dân\"?",
        answers: { A: "Tôn giáo là phương thuốc chữa trị bách bệnh cho thể xác con người", B: "Tôn giáo xoa dịu nỗi đau khổ thực tế của con người bằng ảo tưởng, hướng họ đến hạnh phúc kiếp sau và làm tê liệt ý chí đấu tranh giai cấp của họ", C: "Tôn giáo là động lực khoa học thúc đẩy sự phát triển kinh tế tư bản chủ nghĩa", D: "Tôn giáo là thiết chế xã hội tiến bộ nhất cần được bảo tồn vĩnh viễn" },
        correct: "B",
        explain: "Marx coi tôn giáo là tiếng thở dài của chúng sinh bị áp bức, là hạnh phúc ảo tưởng của nhân dân, khiến họ cam chịu cảnh khổ cực ở trần gian để mong đợi phần thưởng ở thế giới bên kia."
    },
    {
        question: "Theo phân tích của Karl Marx, mâu thuẫn cơ bản của xã hội tư bản chủ nghĩa thể hiện ở mặt kinh tế là gì?",
        answers: { A: "Mâu thuẫn giữa nông nghiệp và công nghiệp", B: "Mâu thuẫn giữa lực lượng sản xuất mang tính xã hội hóa ngày càng cao với quan hệ sản xuất dựa trên chế độ chiếm hữu tư nhân tư bản chủ nghĩa về tư liệu sản xuất", C: "Mâu thuẫn giữa các nhà tư bản thuộc các quốc gia khác nhau trên thế giới", D: "Mâu thuẫn giữa nhu cầu tiêu dùng và khả năng cung cấp nguyên liệu tự nhiên" },
        correct: "B",
        explain: "Đây là mâu thuẫn nội tại sâu sắc nhất của chủ nghĩa tư bản, là nguyên nhân gây ra các cuộc khủng hoảng kinh tế chu kỳ và chỉ có thể được giải quyết thông qua cuộc cách mạng xã hội."
    },
    {
        question: "Giai cấp nào được Karl Marx xác định là lực lượng tiên phong, có sứ mệnh lịch sử xóa bỏ chủ nghĩa tư bản và xây dựng xã hội cộng sản chủ nghĩa?",
        answers: { A: "Giai cấp nông dân", B: "Tầng lớp trí thức, học giả", C: "Giai cấp vô sản (công nhân công nghiệp hiện đại)", D: "Giai cấp tiểu tư sản thành thị" },
        correct: "C",
        explain: "Giai cấp vô sản là sản phẩm đặc trưng nhất của nền đại công nghiệp, đại diện cho lực lượng sản xuất tiên tiến, có tính tổ chức, kỷ luật cao và có lợi ích trực tiếp đối lập với giai cấp tư sản."
    },
    {
        question: "Xã hội học của Karl Marx đặt trọng tâm nghiên cứu vào khía cạnh nào của hệ thống xã hội?",
        answers: { A: "Sự đồng thuận, hài hòa và trật tự xã hội ổn định", B: "Sự xung đột xã hội, mâu thuẫn giai cấp và sự biến đổi cách mạng", C: "Các hành vi giao tiếp biểu trưng hàng ngày giữa các cá nhân", D: "Các chuẩn mực đạo đức tôn giáo duy trì đoàn kết xã hội" },
        correct: "B",
        explain: "Trái ngược với Comte (nhấn mạnh trật tự và thực chứng), Marx tiếp cận xã hội từ góc độ lý thuyết xung đột, coi mâu thuẫn và đấu tranh xã hội là động lực thúc đẩy lịch sử phát triển."
    },
    {
        question: "Khi phân tích về tích lũy tư bản, Karl Marx chỉ ra rằng xu hướng chung của nền sản xuất tư bản chủ nghĩa là gì?",
        answers: { A: "Sự phân bổ tài sản ngày càng đồng đều giữa tất cả các tầng lớp xã hội", B: "Sự tích tụ và tập trung tư bản ngày càng lớn vào tay một số ít nhà tư bản lớn, đồng thời bần cùng hóa giai cấp vô sản", C: "Việc tự động biến mất của giai cấp công nhân do công nghệ phát triển", D: "Sự hòa tan hoàn toàn của giai cấp tư sản vào đời sống của người lao động" },
        correct: "B",
        explain: "Quy luật chung của tích lũy tư bản dẫn tới sự phân cực xã hội sâu sắc: một cực tích lũy sự giàu sang, phú quý vào tay giai cấp thống trị; cực đối diện tích lũy sự nghèo khổ, áp bức và tha hóa đối với giai cấp vô sản."
    },
    {
        question: "Trong lý thuyết duy vật lịch sử, \"Cơ sở hạ tầng\" quyết định \"Kiến trúc thượng tầng\" chủ yếu ở những nội dung nào?",
        answers: { A: "Sự ra đời, tính chất và sự biến đổi của kiến trúc thượng tầng đều do cơ sở hạ tầng quyết định", B: "Cơ sở hạ tầng quyết định số lượng thành viên của bộ máy nhà nước", C: "Cơ sở hạ tầng trực tiếp quyết định khí hậu và tài nguyên của quốc gia đó", D: "Cơ sở hạ tầng quyết định các phát minh toán học và vật lý học lý thuyết" },
        correct: "A",
        explain: "Khi cơ sở hạ tầng thay thế hoặc biến đổi thì sớm hay muộn toàn bộ kiến trúc thượng tầng đồ sộ cũng bị biến đổi theo để phù hợp với cơ sở kinh tế mới."
    },
    {
        question: "Thuật ngữ \"Hệ tư tưởng\" (Ideology) trong phê phán của Karl Marx mang nghĩa tiêu cực nào sau đây?",
        answers: { A: "Một hệ thống các công thức toán học trừu tượng", B: "Ý thức giả tạo, nhận thức sai lệch hoặc bị bóp méo về thực tại xã hội nhằm bảo vệ quyền lợi của giai cấp thống trị", C: "Toàn bộ tri thức khoa học thực chứng về tự nhiên", D: "Các quy tắc ứng xử giao tiếp văn minh của xã hội" },
        correct: "B",
        explain: "Marx phê phán hệ tư tưởng tư sản là \"ý thức giả tạo\" vì nó trình bày lợi ích riêng biệt của giai cấp tư sản như thể đó là lợi ích chung của toàn xã hội nhằm hợp thức hóa sự thống trị của chúng."
    },
    {
        question: "Theo Karl Marx, cuộc cách mạng xã hội thực chất là gì?",
        answers: { A: "Một sự thay đổi đơn thuần về nhân sự trong bộ máy chính phủ", B: "Sự thay đổi triệt để từ hình thái kinh tế - xã hội này sang hình thái kinh tế - xã hội khác cao hơn, bắt đầu bằng việc lật đổ chính quyền của giai cấp lỗi thời", C: "Một cuộc cải cách hành chính nhằm tối ưu hóa các thủ tục pháp lý", D: "Sự điều chỉnh mức thuế thu nhập cánhân của người lao động" },
        correct: "B",
        explain: "Cách mạng xã hội là bước chuyển nhảy vọt về chất trong tiến trình lịch sử, thay thế quan hệ sản xuất cũ lỗi thời bằng quan hệ sản xuất mới tiến bộ, giải phóng lực lượng sản xuất bị kìm hãm."
    },
    {
        question: "Tại sao Marx cho rằng giai cấp vô sản dưới chủ nghĩa tư bản lại có tính đoàn kết quốc tế cao?",
        answers: { A: "Vì họ có ngôn ngữ giao tiếp chung giống nhau ở mọi quốc gia", B: "Vì họ không có tư sản, không bị ràng buộc bởi lợi ích tư hữu quốc gia và cùng chung một kẻ thù bóc lột là giai cấp tư sản quốc tế", C: "Vì chính phủ các nước tư bản chủ nghĩa khuyến khích họ liên kết với nhau", D: "Vì họ thường xuyên đi du lịch và làm việc ở nước ngoài" },
        correct: "B",
        explain: "Giai cấp công nhân ở mọi quốc gia đều chịu chung sự áp bức của chủ nghĩa tư bản thế giới; khẩu hiệu kết thúc Tuyên ngôn của Đảng Cộng sản là \"Vô sản tất cả các nước, đoàn kết lại!\"."
    },
    {
        question: "Đặc trưng cơ bản nhất của hình thái kinh tế - xã hội Cộng sản chủ nghĩa ở giai đoạn cao theo dự báo của Karl Marx là gì?",
        answers: { A: "Nhà nước chuyên chính vô sản ngày càng mạnh mẽ và bạo lực hơn", B: "Xóa bỏ hoàn toàn chế độ tư hữu, phân phối sản phẩm theo nguyên tắc: \"Làm theo năng lực, hưởng theo nhu cầu\"", C: "Sự phân chia giai cấp ngày càng chi tiết và tinh vi hơn", D: "Mọi hoạt động sản xuất công nghiệp đều bị bãi bỏ để quay về với thiên nhiên" },
        correct: "B",
        explain: "Ở giai đoạn cao của xã hội cộng sản, lực lượng sản xuất phát triển cực kỳ dồi dào, sự phân biệt giai cấp và phân công lao động cũ biến mất, xã hội thực hiện phân phối sản phẩm theo nhu cầu thực tế của mỗi cá nhân."
    },
    {
    ...
    {
        question: "Marx gọi quá trình tước đoạt tư liệu sản xuất của những người sản xuất nhỏ (như nông dân, thợ thủ công) để biến họ thành những người lao động tự do nhưng không có tài sản, đồng thời tích lũy tiền bạc vào tay các nhà tư bản sơ khởi là gì?",
        answers: { A: "Tích lũy tái sản xuất mở rộng", B: "Tích lũy nguyên thủy của tư bản (Primitive accumulation of capital)", C: "Quốc hữu hóa tài sản xã hội", D: "Toàn cầu hóa kinh tế thế giới" },
        correct: "B",
        explain: "Tích lũy nguyên thủy là tiến trình lịch sử chia tách người sản xuất ra khỏi tư liệu sản xuất của họ, tạo ra các điều kiện tiên quyết cho sự ra đời của phương thức sản xuất tư bản chủ nghĩa."
    },
    {
        question: "Đóng góp lớn nhất của lý thuyết xã hội học Karl Marx đối với khoa học xã hội hiện đại là gì?",
        answers: { A: "Đưa ra các phương pháp phân tích thống kê toán học phức tạp", B: "Xây dựng lý thuyết phân tích cấu trúc giai cấp, bất bình đẳng xã hội và đặt nền móng cho xã hội học xung đột", C: "Chứng minh rằng trật tự xã hội luôn duy trì trạng thái cân bằng vĩnh cửu", D: "Khẳng định tư tưởng đạo đức tôn giáo quyết định sự phát triển của kinh tế thế giới" },
        correct: "B",
        explain: "Karl Marx đã xây dựng một hệ thống lý thuyết sắc bén về cơ cấu giai cấp, sự bóc lột, tha hóa lao động và xung đột xã hội, tạo tiền đề định hình cho các lý thuyết phê phán và xã hội học hiện đại nghiên cứu về bất bình đẳng."
    }
];
