...
# Toàn bộ dữ liệu 50 câu hỏi Herbert Spencer do người dùng cung cấp
spencer_questions = [
    {
    ...
    },
    {
        ...
        "answers": {"A": "Chủ nghĩa cấu trúc xã hội", "B": "Chủ nghĩa Darwin xã hội (Social Darwinism)", "C": "Chủ nghĩa duy vật biện chứng", "D": "Chủ nghĩa hiện tượng học"},
        "correct": "B",
    ...
    },
    {
        ...
        "answers": {"A": "Cơ thể sinh học có thể di chuyển còn xã hội thì không", "B": "In cơ thể sinh học, ý thức tập trung ở một bộ phận (não bộ); còn trong xã hội, ý thức lan tỏa và tồn tại ở tất cả các cá nhân cấu thành", "C": "Cơ thể sinh học chịu sự chi phối của quy luật tự nhiên còn xã hội thì không", "D": "Xã hội có quy mô nhỏ hơn cơ thể sinh học rất nhiều"},
        "correct": "B",
    ...
    {
        "question": "Trong hệ thống xã hội của Herbert Spencer, thiết chế nào đóng vai trò tương đương với \"Hệ thống điều tiết\" (não bộ và hệ thần kinh) của cơ thể sinh học?",
    ...
    },
    {
        ...
        "answers": {"A": "Định hướng và lập kế hoạch cho toàn bộ nền kinh tế quốc gia", "B": "Giáo dục đạo đức và cung cấp cứu tế xã hội cho mọi người nghèo", "C": "Bảo vệ quyền tự do cá nhân, bảo đảm thực thi hợp đồng và duy trì trật tự an ninh (nhà nước tối thiểu)", "D": "Sơ hữu toàn bộ các tư liệu sản xuất chủ yếu của xã hội"},
        "correct": "C",
    ...
    {
        "question": "In tác phẩm \"Tĩnh học xã hội\", Spencer đưa ra \"Luật tự do bình đẳng\" (Law of equal freedom) với nội dung cốt lõi là gì?",
    ...
    },
    {
        ...
        "answers": {"A": "Nhà tù và các đồn cảnh sát chính trị", "B": "Hệ thống giao thông đường sắm, chợ, ngân hàng và phương tiện phân phối hàng hóa", "C": "Các trường học và viện nghiên cứu khoa học", "D": "Các nghi lễ tôn giáo thờ cúng tổ tiên"},
        "correct": "B",
...
# Viết cấu trúc dữ liệu JS hoàn chỉnh tương thích tốt với code frontend cũ
js_data_content = "const QUIZ_QUESTIONS = " + json.dumps(spencer_questions, ensure_ascii=False, indent=4) + ";"

with open("de-bai-3.js", "w", encoding="utf-8") as f:
